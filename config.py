...
OWNER = os.environ.get("OWNER", "Sourov_Nobita") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "6163647625")) # Owner id
#--------------------------------------------
...
#--------------------------------------------
#--------------------------------------------
START_MSG = os.environ.get("START_MESSAGE", "𝙒𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙍𝙖𝙧𝙚 𝘼𝙣𝙞𝙢𝙚 𝙃𝙪𝙗 𝙊𝙛𝙛𝙞𝙘𝙞𝙖𝙡 𝘽𝙊𝙏! 🎉  
